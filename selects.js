document.getElementById('class_id').onchange = function () {
    ...
    $(function () {
        $.ajax({
            url: 'https://reverse.banka.gr:2053/https://www.iep.edu.gr/services/mitroo/trapeza/public/data.php?q=lesson&schooltype=1&class=' + String(document.getElementById('class_id').options[document.getElementById('class_id').selectedIndex].id),
            type: "GET",
            dataType: 'json',
...
document.getElementById('lesson_id').onchange = function () {
    ...
    $(function () {
        $.ajax({
            url: 'https://reverse.banka.gr:2053/https://www.iep.edu.gr/services/mitroo/trapeza/public/data.php?q=subject&schooltype=1&class=' + String(document.getElementById('class_id').options[document.getElementById('class_id').selectedIndex].id) + '&lesson=' + lesson_id,
            type: "GET",
            dataType: 'json',
            error: function () {
                setTimeout(() => {
