...
document.getElementById('lesson_id').onchange = function () {
    ...
    $(function () {
        $.ajax({
            url: 'https://reverse.banka.gr:8443/https://www.iep.edu.gr/services/mitroo/trapeza/public/data.php?q=subject&schooltype=1&class=' + String(document.getElementById('class_id').options[document.getElementById('class_id').selectedIndex].id) + '&lesson=' + lesson_id,
            type: "GET",
            dataType: 'json',
            error: function () {
                setTimeout(() => {
